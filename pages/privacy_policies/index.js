    ...
    <div style={{padding: '30px'}}>
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          A sua privacidade é importante para nós. É política do Caderneta
          Digital respeitar a sua privacidade em relação a qualquer informação
          sua que possamos coletar no site{' '}
          <a href='https://www.cadernetadg.com.br/'>Caderneta Digital</a>, e
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          ...
          informação que o Caderneta Digital oferece no site e com caráter
      ...
      <ul>
        ...
        <li>
          <span style={{ color: 'rgb(68, 68, 68)' }}>
            ...
            (softwares) do Caderneta Digital, de seus fornecedores ou terceiros,
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          Esta política é efetiva a partir de&nbsp;29 January 2023 04:16
        </span>
      </p>
    </div>
  );
