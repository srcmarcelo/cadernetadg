    ...
    <div style={{ padding: '30px' }}>
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          Ao acessar ao site{' '}
          <a href='https://www.cadernetadg.com.br/'>Caderneta Digital</a>,
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          ...
          materiais (informações ou software) no site Caderneta Digital , apenas
      ...
      <ol>
        ...
        <li>
          <span style={{ color: 'rgb(68, 68, 68)' }}>
            ...
            contido no site Caderneta Digital;&nbsp;
          </span>
        </li>
        <li>
          <span style={{ color: 'rgb(68, 68, 68)' }}>
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          ...
          dessas restrições e poderá ser rescindida por Caderneta Digital a
      ...
      <ol>
        <li>
          <span style={{ color: 'rgb(68, 68, 68)' }}>
            Os materiais no site da Caderneta Digital são fornecidos 'como
            estão'. Caderneta Digital não oferece garantias, expressas ou
        ...
        <li>
          <span style={{ color: 'rgb(68, 68, 68)' }}>
            Além disso, o Caderneta Digital não garante ou faz qualquer
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          Em nenhum caso o Caderneta Digital ou seus fornecedores serão
          ...
          Caderneta Digital, mesmo que Caderneta Digital ou um representante
          autorizado da Caderneta Digital tenha sido notificado oralmente ou por
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          Os materiais exibidos no site da Caderneta Digital podem incluir erros
          técnicos, tipográficos ou fotográficos. Caderneta Digital não garante
          que qualquer material em seu site seja preciso, completo ou atual.
          Caderneta Digital pode fazer alterações nos materiais contidos em seu
          site a qualquer momento, sem aviso prévio. No entanto, Caderneta
          Digital não se compromete a atualizar os materiais.
        </span>
      </p>
      <h2>
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          O Caderneta Digital não analisou todos os sites vinculados ao seu site
          e não é responsável pelo conteúdo de nenhum site vinculado. A inclusão
          de qualquer link não implica endosso por Caderneta Digital do site. O
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          O Caderneta Digital pode revisar estes termos de serviço do site a
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>
          ...
          leis do Caderneta Digital e você se submete irrevogavelmente à
